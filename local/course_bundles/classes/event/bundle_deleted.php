 ...
 */
class bundle_deleted extends \core\event\base {
     /**
      * Init method
      */
     ...
     public function get_description() {
         return new \lang_string('coursebundlesdeleted', 'course_bundles');
     }
     ...
     public function get_url() {
         return new \moodle_url('/local/course_bundles/index.php');
     }
 }