 ...
 */
class local_course_bundles_events {
    /**
    ...
    public static function response_answer($objectid = 0, $response = array()) {
        ...
        $event = local_course_bundles\event\response_answer::create(
            array(
                "context"  => $context,
                "objectid" => $objectid,
    ...
    /**
     * Call the event when the bundle is added
     * 
     * @param number $objectid Bundle ID
     */
    public static function bundle_added($objectid = 0) {
        $context = context_system::instance();
        
        $event = local_course_bundles\event\bundle_added::create(
            array(
                'context' => $context,
                'objectid' => $objectid
            )
     ...
     * @param number $objectid Bundle ID
     */
    public static function bundle_deleted($objectid = 0) {
        $context = context_system::instance();
        
        $event = local_course_bundles\event\bundle_deleted::create(
            array(
                'context' => $context,
                'objectid' => $objectid
            )
     ...
     * @param number $objectid Bundle ID
     */
    public static function bundle_updated($objectid = 0) {
        $context = context_system::instance();
        
        $event = local_course_bundles\event\bundle_updated::create(
            array(
                'context' => $context,
                'objectid' => $objectid
            )
