 ...
 *
 * @package    customcertelement_studentaddress
 * @copyright  2018 Pivot Creative
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace customcertelement_studentaddress;
...
class element extends \mod_customcert\element {
    ...
    public function render($pdf, $preview, $user) {
        ...
        foreach($user_info_data as $license_info) {
            switch ($license_info->fieldid) {
                case 7:
                    $address = $license_info->data;
                    break;
                case 8:
                    $city = $license_info->data;
                    break;
                case 9:
                    $state = $license_info->data;
                    break;
                case 10:
                    $zip_code = $license_info->data;
                    break;
            }
        }
        ...
        $view_str = $address . "<br>";
        $view_str .= $city . ", " . $state . " " . $zip_code . "<br>";
    ...
    public function render_html() {
        ...
        // build the content to show for each state
        $view_str = '123 Main Street<br />';
        $view_str .= 'Ellabell, GA 31308<br />';
